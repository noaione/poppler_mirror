...
public:
    ...
    // Returns success.
    std::optional<CryptoSign::SigningErrorMessage> signDocument(const std::string &filename, const std::string &certNickname, const std::string &timestampServer, const std::string &password, const GooString *reason = nullptr,
                                                                const GooString *location = nullptr, const std::optional<GooString> &ownerPassword = {}, const std::optional<GooString> &userPassword = {});

    // Same as above but adds text, font color, etc.
    std::optional<CryptoSign::SigningErrorMessage> signDocumentWithAppearance(const std::string &filename, const std::string &certNickname, const std::string &timestampServer, const std::string &password, const GooString *reason = nullptr,
                                                                              const GooString *location = nullptr, const std::optional<GooString> &ownerPassword = {}, const std::optional<GooString> &userPassword = {},
